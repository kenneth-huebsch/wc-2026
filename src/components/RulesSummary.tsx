  ...
  return (
    <section className="card">
      ...
      <ol className="rules-list">
        <li>Participants invest whole-dollar amounts in any teams they choose before the pool locks.</li>
        ...
        <li>Each knockout match is winner-take-all: the winner earns and carries forward both teams&apos; values.</li>
        <li>Participant scores are the sum of ownership-adjusted points across all owned teams.</li>
      </ol>
